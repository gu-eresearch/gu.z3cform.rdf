...
from gu.z3cform.rdf.vocabulary import SparqlInstanceVocabularyFactory, SparqlVocabularyFactory
...
class Fresnel(Graph):
    ...
    def __init__(self, *av, **kw):
        ...
        self.lenses = {}
        self.classLenses = {}  # there might be more than one here for the same class
...
class Field(Graph):
    ...
    def initField(self, prop, fieldkw):
        field = None
        # TODO: possibly do some error checking here; at least to generate meaningful errors
        ...
        if ICollection.implementedBy(fieldClass):
            ...
            if vocabulary is not None:
                ...
                subfieldkw['vocabulary'] = self.fresnel.vocabularies[vocabulary]()
...
class Vocabulary(Graph):
    # this class may be suitable as vocabularyfactory, I am just not sure how to register it properly,
    # as the connection to the triple store might not yet be available at that time.
